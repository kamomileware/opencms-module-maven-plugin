...
import com.camomileware.maven.plugin.opencms.packaging.ModulePackagingTask;
import com.camomileware.maven.plugin.opencms.packaging.ModulePostPackagingTask;
import com.camomileware.maven.plugin.opencms.packaging.ModuleProjectPackagingTask;
import com.camomileware.maven.plugin.opencms.packaging.SaveModuleStructurePostPackagingTask;
import com.camomileware.maven.plugin.opencms.util.ModuleStructure;
import com.camomileware.maven.plugin.opencms.util.ModuleStructureSerializer;
