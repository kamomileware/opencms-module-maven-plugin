...
import com.camomileware.maven.plugin.AbstractModuleMojo;
import com.camomileware.maven.plugin.util.MappingUtils;
import com.camomileware.maven.plugin.util.ModuleStructure;
import com.camomileware.maven.plugin.util.PathSet;
