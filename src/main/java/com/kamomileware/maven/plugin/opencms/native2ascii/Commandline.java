...
package com.kamomileware.maven.plugin.opencms.native2ascii;
...
public class Commandline implements Cloneable {
     ...
     */
    public Commandline(String toProcess) throws MojoExecutionException {
        super();
    ...
    public static class Argument {
         ...
         * @throws MojoExecutionException
         */
        public void setLine(String line) throws MojoExecutionException {
            if (line == null) {
                return;
            }
...
//        }
     ...
     * @throws MojoExecutionException if the argument contains both, single and double quotes.
     */
    public static String quoteArgument(String argument) throws MojoExecutionException {
        if (argument.indexOf("\"") > -1) {
            if (argument.indexOf("\'") > -1) {
                throw new MojoExecutionException("Can\'t handle single and double"
     ...
     * @throws MojoExecutionException
     */
    public static String toString(String[] line) throws MojoExecutionException {
     ...
     * @throws MojoExecutionException
     */
    public static String[] translateCommandline(String toProcess) throws MojoExecutionException {
        ...
        if (state == inQuote || state == inDoubleQuote) {
            throw new MojoExecutionException("unbalanced quotes in " + toProcess);
        }
